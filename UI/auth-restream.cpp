...
#define RESTREAM_AUTH_URL "https://obs-oauth.jmickelonis.workers.dev/v1/restream/redirect"
#define RESTREAM_TOKEN_URL "https://obs-oauth.jmickelonis.workers.dev/v1/restream/token"

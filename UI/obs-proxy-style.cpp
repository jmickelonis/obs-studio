...
void OBSProxyStyle::drawControl(ControlElement element,
				...
				const QWidget *widget) const
{
	if (element == QStyle::CE_RubberBand) {
		...
		QColor fillColor =
			QColor(windowColor.red() * wcAmount +
				       highlightColor.red() * hcAmount,
			       windowColor.green() * wcAmount +
				       highlightColor.green() * hcAmount,
			       windowColor.blue() * wcAmount +
				       highlightColor.blue() * hcAmount);

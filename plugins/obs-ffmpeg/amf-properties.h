...
static const char *amf_avc_property_categories[] = {
	"Static", "Color Conversion", "Rate Control", "Picture Control", "Miscellaneous",
};
	...
	{"Rate Control",
	 {
		 ...
		 _ITEM(PREENCODE_ENABLE, PREENCODE_MODE),
...
#define _ITEM(NAME) {AMF_VIDEO_ENCODER_##NAME, #NAME}
		_ENUM(CODING, AMF_VIDEO_ENCODER,
		      {
			      _ITEM(UNDEFINED),
			      _ITEM(CABAC),
			      _ITEM(CALV),
...
#define _ITEM(NAME) {AMF_VIDEO_ENCODER_LTR_MODE_##NAME, #NAME}
		_ENUM(LTR_MODE, AMF_VIDEO_ENCODER_LTR_MODE,
		      {
			      _ITEM(RESET_UNUSED),
			      _ITEM(KEEP_UNUSED),
		      })
...
#define _ITEM(NAME) {AMF_VIDEO_ENCODER_OUTPUT_MODE_##NAME, #NAME}
		_ENUM(OUTPUT_MODE, AMF_VIDEO_ENCODER_OUTPUT_MODE,
		      {
			      _ITEM(FRAME),
			      _ITEM(SLICE),
		      })
#define _ITEM(NAME) {AMF_VIDEO_ENCODER_PICTURE_TRANSFER_MODE_##NAME, #NAME}
		_ENUM(PICTURE_TRANSFER_MODE, AMF_VIDEO_ENCODER_PICTURE_TRANSFER_MODE,
		      {
			      _ITEM(OFF),
			      _ITEM(ON),
		      })
#define _ITEM(NAME) {AMF_VIDEO_ENCODER_PREENCODE_##NAME, #NAME}
		_ENUM(PREENCODE_MODE, AMF_VIDEO_ENCODER_PREENCODE,
		      {
			      _ITEM(DISABLED),
			      _ITEM(ENABLED),
		      })
#define _ITEM(NAME) {AMF_VIDEO_ENCODER_PROFILE_##NAME, #NAME}
		_ENUM(PROFILE, AMF_VIDEO_ENCODER_PROFILE,
		      {
			      _ITEM(BASELINE),
			      _ITEM(MAIN),
			      _ITEM(HIGH),
...
#define _ITEM(NAME) {AMF_VIDEO_ENCODER_QUALITY_PRESET_##NAME, #NAME}
		_ENUM(QUALITY_PRESET, AMF_VIDEO_ENCODER_QUALITY_PRESET,
		      {
			      _ITEM(BALANCED),
			      _ITEM(SPEED),
			      _ITEM(QUALITY),
...
#define _ITEM(NAME) {AMF_VIDEO_ENCODER_RATE_CONTROL_METHOD_##NAME, #NAME}
		_ENUM(RATE_CONTROL_METHOD, AMF_VIDEO_ENCODER_RATE_CONTROL_METHOD,
		      {
			      _ITEM(UNKNOWN),
			      _ITEM(CONSTANT_QP),
			      _ITEM(CBR),
...
#define _ITEM(NAME) {AMF_VIDEO_ENCODER_SCANTYPE_##NAME, #NAME}
		_ENUM(SCANTYPE, AMF_VIDEO_ENCODER_SCANTYPE,
		      {
			      _ITEM(PROGRESSIVE),
			      _ITEM(INTERLACED),
		      })
#define _ITEM(NAME) {AMF_VIDEO_ENCODER_USAGE_##NAME, #NAME}
		_ENUM(USAGE, AMF_VIDEO_ENCODER_USAGE,
		      {
			      _ITEM(TRANSCODING),

...
function(_check_dependencies)
  ...
  foreach(dependency IN LISTS dependencies_list)
    if(dependency STREQUAL cef OR dependency MATCHES "^cef-")
      # CEF has multiple keys in the JSON data
      set(IS_CEF TRUE)
    else()
      set(IS_CEF FALSE)
    endif()

    if(IS_CEF AND NOT ENABLE_BROWSER)
      continue()
    endif()
    if(IS_CEF AND arch STREQUAL universal)
    ...
    if(IS_CEF)
      # Set this so file/destination isn't blank
      set(dependency cef)
    endif()
